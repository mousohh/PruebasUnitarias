...
router.post("/", authorizeRoles(1), RepuestoController.crear)

// Actualizar un repuesto existente (solo rol Administrador)
router.put("/:id", authorizeRoles(1), RepuestoController.actualizar)

// Cambiar estado de repuesto (corregir la ruta)
router.put("/:id/cambiar-estado", authorizeRoles(1), RepuestoController.cambiarEstado)

// Eliminar un repuesto (solo rol Administrador)
router.delete("/:id", authorizeRoles(1), RepuestoController.eliminar)
